...
void test_fnet_http2() {
    ...
    auto scb = [](void* u, utils::fnet::http2::frame::Frame& f, utils::fnet::http2::stream::StreamNumState state) {
    ...
    auto ccb = [](void* u, utils::fnet::http2::frame::Frame& f, utils::fnet::http2::stream::StreamNumState state) {
