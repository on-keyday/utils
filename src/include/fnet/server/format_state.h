    ...
    namespace fnet::server {
        ...
        String format_state(const Counter& servstate) {
            ...
            w.set_indent("    ");
            {
                ...
                field("waiting_async_write", servstate.waiting_async_write.load());
                field("total_async_read_invocation", servstate.total_async_read_invocation.load());
                field("total_async_write_invocation", servstate.total_async_write_invocation.load());
                field("max_concurrent_async_read_invocation", servstate.max_concurrent_async_read_invocation.load());
                ...
                field("total_failed_read_async", servstate.total_failed_read_async.load());
                field("total_failed_write_async", servstate.total_failed_write_async.load());
