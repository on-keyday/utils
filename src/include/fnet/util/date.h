                ...
                struct DateParser {
                   ...
                   private:
                    ...
                    static DateErr set_time(Date& date, string_t& src) {
                        ...
                        auto time = strutil::split<string_t, Vec>(src, ":");
                        if (time.size() != 3) {
                ...
                struct DateWriter {
                   ...
                   public:
                    static DateErr write(string_t& towrite, const Date& date) {
                        ...
                        strutil::append(towrite, get_dayname(date.dayname));
                        ...
                        strutil::append(towrite, get_month(date.month));
                        towrite.push_back(' ');
                        if (date.year > 9999) {
                            return DateError::not_year;
                        }
