...
namespace utils {
    namespace minilang {
        namespace parser {
            ...
            auto string(bool allow_multi_line) {
            ...
            auto ident(Fn ident_read = ident_default_read, bool none_is_err = true) {
            ...
            auto filter_passloc(auto inner, pass_loc loc) {
                return [=](auto&& p) {
                    if (p.loc != loc) {
