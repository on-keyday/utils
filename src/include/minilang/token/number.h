...
namespace utils {
    namespace minilang::token {
        ...
        template <class TypeConfig = number::internal::ReadConfig>
        constexpr auto yield_number(int radix, bool allow_float, TypeConfig&& conf = number::internal::ReadConfig{}) {
        ...
        template <class TypeConfig = number::internal::ReadConfig>
        constexpr auto yield_radix_number(bool allow_float, TypeConfig&& conf = number::internal::ReadConfig{}) {
            return [=](auto& src) -> std::shared_ptr<Number> {
