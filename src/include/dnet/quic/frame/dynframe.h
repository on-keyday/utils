...
namespace utils {
    namespace dnet::quic::frame {
        ...
        using DynFramePtr = std::unique_ptr<DynFrame, dnet::internal::Delete>;

        template <class F>
        inline std::unique_ptr<DynFrameImpl<std::decay_t<F>>, dnet::internal::Delete> makeDynFrame(F&& f) {
            ...
            return std::unique_ptr<Dyn, dnet::internal::Delete>{ptr};
        }
