            ...
            struct OptParser {
               private:
                struct NOVTABLE__ interface__ {
                    virtual bool is_parsable(int index, int argc, char** argv, const wrap::string& optname) = 0;
                    virtual bool parse(int& index, int argc, char** argv, Ctx& ctx) = 0;
                ...
                struct implements__ : interface__ {
                    ...
                    bool is_parsable(int index, int argc, char** argv, const wrap::string& optname) override {
                        auto t_ptr_ = utils::helper::deref(this->t_holder_);
                        if (!t_ptr_) {
                            return bool{};
                        }
                        return t_ptr_->is_parsable(index, argc, argv, optname);
                    }

                    bool parse(int& index, int argc, char** argv, Ctx& ctx) override {
                        auto t_ptr_ = utils::helper::deref(this->t_holder_);
                        if (!t_ptr_) {
                            return bool{};
                        }
                        return t_ptr_->parse(index, argc, argv, ctx);
                    }
                };
               ...
               public:
                ...
                bool is_parsable(int index, int argc, char** argv, const wrap::string& optname) {
                    return iface ? iface->is_parsable(index, argc, argv, optname) : bool{};
                }

                bool parse(int& index, int argc, char** argv, Ctx& ctx) {
                    return iface ? iface->parse(index, argc, argv, ctx) : bool{};
                }
