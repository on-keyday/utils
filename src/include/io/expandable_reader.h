    ...
    namespace io {
        ...
        struct basic_expand_reader {
           ...
           public:
            ...
            constexpr basic_reader<C, U> reader() const {
                return r;
            }
            ...
            constexpr view::basic_rvec<C, U> read() {
                return r.read();
            }
            ...
            constexpr bool read(view::basic_wvec<C, U> data) {
        ...
        template <class T>
        using expand_reader = basic_expand_reader<T, byte, char>;
    }  // namespace io
}  // namespace utils
