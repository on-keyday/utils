    ...
    namespace platform {
        namespace windows {
            struct CCBImpl {
               private:
                struct vtable__t {
                    void (*invoke__)(void* this__, void* ol, size_t com) = nullptr;
                };
                ...
                struct vtable__instance__ {
                   private:
                    ...
                    static void invoke__(void* this__, void* ol, size_t com) {
                        return (*static_cast<this_type*>(this__))(ol, com);
                    }
                ...
                struct vtable__interface__ {
                   ...
                   public:
                    ...
                    void operator()(void* ol, size_t com) {
                        return vtable__->invoke__(this__, ol, com);
                    }
                };

               private:
                struct NOVTABLE__ interface__ {
                    virtual void operator()(void* ol, size_t com) = 0;
                ...
                struct implements__ : interface__ {
                    ...
                    void operator()(void* ol, size_t com) override {
                        auto t_ptr_ = utils::helper::deref(this->t_holder_);
                        if (!t_ptr_) {
                            return (void)0;
                        }
                        return (*t_ptr_)(ol, com);
                    }
               ...
               public:
                ...
                void operator()(void* ol, size_t com) {
                    return iface ? iface->operator()(ol, com) : (void)0;
                }
            ...
            using CompletionCallback = decltype(std::declval<CCBImpl>().get_self_vtable());
