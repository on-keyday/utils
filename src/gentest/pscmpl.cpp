...
size_t tmpvar_0_BpTVXlUyDu1sKclg0Iz7 = input.pos();
...
tmpvar_0_BpTVXlUyDu1sKclg0Iz7= input.pos(); // update index
}
input.set_pos(tmpvar_0_BpTVXlUyDu1sKclg0Iz7);
...
// consume tokens while condition is true
size_t tmpvar_1_BVJhrtggMCPpVuGqiYkF = input.pos();
while(SPACE(input,output)) {
tmpvar_1_BVJhrtggMCPpVuGqiYkF= input.pos(); // update index
}
input.set_pos(tmpvar_1_BVJhrtggMCPpVuGqiYkF);
...
// consume tokens while condition is true
size_t tmpvar_2_Engi61b0JQ5FPDszfM8q = input.pos();
while(MEMBER(input,output)) {
tmpvar_2_Engi61b0JQ5FPDszfM8q= input.pos(); // update index
}
input.set_pos(tmpvar_2_Engi61b0JQ5FPDszfM8q);
...
// consume tokens while condition is true
size_t tmpvar_3_PsWaWY1WrE1aIW0jMZ8v = input.pos();
while(input.expect(u8"+") || input.expect(u8"*") || input.expect(u8"-")) {
tmpvar_3_PsWaWY1WrE1aIW0jMZ8v= input.pos(); // update index
}
input.set_pos(tmpvar_3_PsWaWY1WrE1aIW0jMZ8v);
...
// consume tokens while condition is true
size_t tmpvar_4_AAbJHuGzWfCcUHM7Zzcv = input.pos();
while(input.expect(u8"+") && VARNAME(input,output)) {
tmpvar_4_AAbJHuGzWfCcUHM7Zzcv= input.pos(); // update index
}
input.set_pos(tmpvar_4_AAbJHuGzWfCcUHM7Zzcv);
